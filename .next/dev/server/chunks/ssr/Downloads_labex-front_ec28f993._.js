...
"[project]/Downloads/labex-front/app/publicacoes/[id]/editar/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditarPublicacaoPage() {
    ...
    const { data: publication, isLoading: pubLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$labex$2d$front$2f$lib$2f$hooks$2f$useQueries$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePublication"])(id);
    ...
    const updateMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$labex$2d$front$2f$lib$2f$hooks$2f$useQueries$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUpdatePublication"])();
    ...
    const [loaded, setLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$labex$2d$front$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$labex$2d$front$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        // Extras do abstract
        newForm.authors = extras["Autores"] || (raw.authors || []).map((a)=>a.name).join(", ");
    ...
    const canEdit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$labex$2d$front$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (!publication || !user) return false;
        const raw = publication;
        return raw.authors?.some((a)=>a.id === user.id) || raw.userId === user.id || raw.createdBy === user.id || raw.authorId === user.id || raw.project?.ownerId === user.id || raw.project?.professorId === user.id || raw.project?.professor?.id === user.id;
    }, [
        publication,
        user
    ]);
...
//# sourceMappingURL=Downloads_labex-front_ec28f993._.js.map