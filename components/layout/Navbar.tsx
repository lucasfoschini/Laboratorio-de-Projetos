            ...
            {isAuthenticated ? (
              <>
                ...
                <Link href="/dashboard" className="flex items-center gap-2 px-3 py-1.5 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all">
                  {user?.avatar ? (
                    <NextImage src={user.avatar} alt={user.name ?? ""} width={28} height={28} className="rounded-full object-cover border-2 border-brand-200" loading="lazy" />
                  ) : (
            ...
            {isAuthenticated ? (
              <>
                <div className="flex items-center gap-3 px-4 py-2.5">
                  {user?.avatar ? (
                    <NextImage src={user.avatar} alt={user?.name ?? ""} width={32} height={32} className="rounded-full object-cover border-2 border-brand-200" loading="lazy" />
                  ) : (
